...
const messages = { // eslint-disable-line no-unused-vars
  en: {
    ...
    tunnelListenPort: 'Listen UDP',
    tunnelAddress: 'Address',
    tunnelPeers: 'Peers',
    tunnelActions: 'Actions',
    addTunnel: 'Add tunnel',
    editTunnel: 'Edit tunnel',
    useForPeers: 'Use for peers',
    resetObfuscation: 'Reset Amnezia params',
    deleteTunnel: 'Delete tunnel',
    tunnelDeleteConfirm: 'Delete tunnel and its configuration from the server?',
    tunnelFormName: 'Interface name (e.g. wg1)',
    tunnelFormListenPort: 'Listen port (optional)',
    tunnelFormAddress: 'LAN CIDR (optional, e.g. 10.66.0.0/24)',
    saveTunnel: 'Save',
    settingsBackupRestore: 'Backup',
    settingsCompatApi: 'API',
    settingsServerRuntime: 'Endpoint & DNS',
    settingsVpn: 'WireGuard VPN',
    settingsGlobalScope: 'All tunnels',
    tunnelOn: 'On',
    tunnelPaused: 'Paused',
    tunnelWaitingVpn: 'Interface enabled in config; start VPN in Settings to bring it up.',
    settingsCompatMode: 'Automation API',
    settingsCompatUseEnv: 'Default (.env)',
    settingsCompatForceOn: 'On',
    settingsCompatForceOff: 'Off',
    settingsEffective: 'Active',
    settingsEnvValue: '.env',
    settingsOverrideActive: 'override',
    settingsSaveRuntime: 'Save',
